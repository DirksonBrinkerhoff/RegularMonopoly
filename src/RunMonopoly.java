...
//																			.getNumberOfHousesOwned() + 1);
		...
		{			
			int playerRoll = 1;
			playerLocation = 20;
			//System.out.println("Your total: " + ReverseDiceRoller.ReverseDiceRoller2() + "\nYou landed on " + MonopDriver.board[playerLocation].getName());

				if ((playerLocation + ReverseDiceRoller.ReverseDiceRoll()) < 39)
					{
						playerLocation += ReverseDiceRoller.ReverseDiceRoll();
					} 
				else if((MonopDriver.board[playerLocation].getName().equals("GO")))
					{
						playerLocation = (playerLocation + ReverseDiceRoller.ReverseDiceRoll()) - 40;
						playerMoney += 200;
						System.out.println("You passsed GO and collected $200");
					}					

				System.out.println("Your total: " + ReverseDiceRoller.ReverseDiceRoll() + "\nYou landed on " + MonopDriver.board[playerLocation].getName());
		...
		{
			if(MonopDriver.board[playerLocation].getName().equals("Free_Parking"))
				{
			
					int playerRoll = ReverseDiceRoller.ReverseDiceRoll();
